...
$conversation_history[] = [
    'role' => 'system',
    'content' => 'Berikan jawaban yang sesuai tentang pendidikan tinggi dan jurusan.'
];
...
$body = [
    ...
    'temperature' => 1 // You can adjust this value based on desired creativity
];
...
$user_avatar_url = "https://cdn-icons-png.flaticon.com/128/1144/1144760.png"; // Implement this function
$bot_image_url = "https://cdn-icons-png.flaticon.com/128/17653/17653338.png"; // Implement this function

$response = array(
'botStatus' => 1,
'StartUpMessage' => "Halo, Apa kabar?",
'fontSize' => '16',
...
'commonButtons' => array(
    array(
        'buttonText' => 'Saya butuh bantuan!',
        'buttonPrompt' => 'Saya punya pertanyaan tentang program Anda'
    ),
    array(
        'buttonText' => 'Tips dan trik memilih jurusan',
        'buttonPrompt' => 'Tips dan trik memilih jurusan'
    )
